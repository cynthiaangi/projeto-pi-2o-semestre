...
public class OcorrenciasDao extends Dao {
    ...
    public void inserirOcorrencia(Integer fkDoenca, Long fkCidade, Integer anoReferencia, Double coberturaVacinal) {
    ...
    public Boolean existsByFksAnual(Long codigoIbge, Integer ano, Integer fkDoenca) {
